...
function getTagStyle(tag) {
    ...
    const locationKeywords = ["구", "시", "도쿄", "오사카", "교토", "나고야", "삿포로", "후쿠오카", "구마모토", "치바", "가마쿠라", "요코하마", "에히메", "가가와", "고치", "도쿠시마", "신바시", "미나토구", "주오구", "시부야구", "신주쿠구", "다카마쓰", "하코다테", "가나자와", "이시카와", "노토", "아오모리", "기후", "미에", "나가노", "시즈오카", "와카야마", "톳토리", "시마네", "오카야마", "히로시마", "야마구치", "후쿠이", "토야마", "나가사키", "오이타", "미야자키", "가고시마", "오키나와", "홋카이도", "센다이", "나라", "아이치"];
...
function renderMarkers() {
    ...
    if (markers.length > 0) {
        ...
        // Use a small timeout to ensure map is ready and avoid layout glitches
        setTimeout(() => {
            if (markers.length === 1) {
                map.setCenter(markers[0].position);
                map.setZoom(15);
            } else if (activeRegion || activeCuisine) {
