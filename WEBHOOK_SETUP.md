...
## 7. 트러블슈팅: ngrok 브라우저 경고 (Visit Site)

무료 버전 ngrok을 사용할 경우, 브라우저 버튼 클릭 시 **"You are about to visit..."** 라는 경고 페이지가 뜰 수 있습니다. 이는 피싱 방지를 위한 ngrok의 보안 표준 절차입니다.

### 해결 방법
1.  경고 페이지 하단의 **[Visit Site]** 파란색 버튼을 클릭합니다.
2.  한 번 클릭하면 해당 브라우저 세션 동안은 다시 나타나지 않습니다.
3.  클릭 즉시 로컬 컴퓨터의 파이프라인이 실행되니 안심하셔도 됩니다.
